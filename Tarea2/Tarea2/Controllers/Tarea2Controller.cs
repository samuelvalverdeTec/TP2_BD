...
namespace Tarea2.Controllers
{
    public class Tarea2Controller : ApiController
    {
        ...
        [HttpPost]
        [Route("validarModificarArticulo")]
        public IHttpActionResult validarModificarArticulo(ArticuloValModifRequest request)
        {
            ArticuloValModifResult result = new ArticuloValModifResult();
            try
            {
                using (SqlConnection con = new SqlConnection(constr))
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("Validar_Modificar_Articulo"))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Connection = con;
                        cmd.CommandTimeout = 60;
        ...
        //metodo modificar
        [HttpPost]
        [Route("modificarArticulo")]
        public IHttpActionResult modificarArticulo(ArticuloModifRequest request)
        {
            ArticuloModifResult result = new ArticuloModifResult();
            try
            {
                using (SqlConnection con = new SqlConnection(constr))
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("Modificar_Articulo"))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Connection = con;
                        cmd.CommandTimeout = 60;
                        cmd.Parameters.Add(new SqlParameter("@inIdUsuarioActual", request.idUsuarioActual));
                        cmd.Parameters.Add(new SqlParameter("@inPostIP", request.postIP));
                        cmd.Parameters.Add(new SqlParameter("@inIdArticuloBuscado", request.idArticuloBuscado));
                        cmd.Parameters.Add(new SqlParameter("@inIdClaseArticulo", request.idClaseArticulo));
                        cmd.Parameters.Add(new SqlParameter("@inCodigo", request.Codigo));
                        cmd.Parameters.Add(new SqlParameter("@inNombre", request.Nombre));
                        cmd.Parameters.Add(new SqlParameter("@inPrecio", request.Precio));
                        ...
                        if (return_Value.Value != DBNull.Value)
                        {
                            ...
                            {
                                result.CodigoError = 0;
                                result.Mensaje = "Se modificó el artículo correctamente";
                            }
                            else
                            {
                                result.CodigoError = resultado;
        ...
        [HttpPost]
        [Route("validarBorrarArticulo")]
        public IHttpActionResult validarBorrarArticulo(ArticuloValDeleteRequest request)
        {
            ArticuloValDeleteResult result = new ArticuloValDeleteResult();
            try
            {
                using (SqlConnection con = new SqlConnection(constr))
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("Validar_Borrar_Articulo"))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Connection = con;
                        cmd.CommandTimeout = 60;
        ...
        public IHttpActionResult borrarArticulo(ArticuloDeleteRequest request)
        {
            ArticuloDeleteResult result = new ArticuloDeleteResult();
            try
            {
                using (SqlConnection con = new SqlConnection(constr))
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("Borrar_Articulo"))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Connection = con;
                        cmd.CommandTimeout = 60;
                        ...
                        if (return_Value.Value != DBNull.Value)
                        {
                            ...
                            {
                                result.CodigoError = 0;
                                result.Mensaje = "Se borró el artículo correctamente";
                            }
                            else
                            {
                                result.CodigoError = resultado;
